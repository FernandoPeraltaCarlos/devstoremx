...
function HomeForm({
  ...
  const copy =
    locale === "en"
      ? {
          bannerAlt: "DevStoreMX, web and software development",
          ...
          linkedinAlt: "DevStoreMX on LinkedIn",
          logoAlt: "DevStoreMX logo",
          preview: "We received your message at DevStoreMX",
          role: "Founder & Technical Lead",
        }
      : {
          bannerAlt: "DevStoreMX, desarrollo web y software",
          ...
          linkedinAlt: "LinkedIn de DevStoreMX",
          logoAlt: "Logotipo de DevStoreMX",
